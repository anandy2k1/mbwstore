<?php
class  Mdlext_Mdloption_Block_Adminhtml_Activate_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('setup_cms', 'checkbox', array(
            'label' => Mage::helper('mdloption')->__('Create Cms Pages & Blocks'),
            'required' => false,
            'name' => 'setup_cms',
            'value' => 1,
        ))->setIsChecked(1);
