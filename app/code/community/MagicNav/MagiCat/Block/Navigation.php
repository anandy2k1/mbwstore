...
class MagicNav_MagiCat_Block_Navigation extends Mage_Catalog_Block_Navigation
{
    ...
    public function drawOpenCategoryItem($category, $level=0, array $levelClass=null)
    {
        ...
        $html[1] = str_pad ( "", (($level * 2 ) + 4), " " ).'<span class="magicat-cat"><i class="icon-angle-right"></i><a href="'.$this->getCategoryUrl($category).'"><span>'.$this->htmlEscape($category->getName()).'</span></a>'.$productCount."</span>\n";
