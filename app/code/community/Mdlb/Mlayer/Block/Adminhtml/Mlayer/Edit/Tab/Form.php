...
class Mdlb_Mlayer_Block_Adminhtml_Mlayer_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
	  ...
	  $fieldset->addField('contentpos', 'select', array(
          'label'     => Mage::helper('mlayer')->__('Content position'),
          'name'      => 'contentpos',
          'values'    => array(
              array(
                  'value'     => 1,
                  'label'     => Mage::helper('mlayer')->__('Left'),
              ),

              array(
                  'value'     => 2,
                  'label'     => Mage::helper('mlayer')->__('Right'),
              ),
			  array(
                  'value'     => 3,
                  'label'     => Mage::helper('mlayer')->__('Center'),
              ),
          ),
      ));
